            ...
            switch (msg.what) {
                case 0:
                    ...
                    try {
                        ...
                        new MainImageConnection(iv_icon).execute(jo.get("image_path").toString().replace(" ", "%20"));
            ...
            public void onSuccess(String result) throws JSONException {
                switch (result) {
                    ...
                    default:
                        ...
                        CurrentUser user = new CurrentUser(edt_loginAccount.getText().toString(), jo.getString("nickname"), jo.getString("image_path"));
